...
#if ESP32_COPRO
#include "../hal/esp32/copro/compile.inlined.h"
#endif
...
#if ESP32_COPRO
  const inline_code_gen_t *method_copros; //!< built-in method function for copro table.
#endif
};
...
#if ESP32_COPRO
  void * copro_func; //!< Coprocessor C function.
#endif
} mrbc_method;
